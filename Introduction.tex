...
\end{lstlisting}
\end{figure}
\todo{example demonstrating the knobs and how RAJA enables P3.}

\section{Cross-Loop Program Transformation}

\todo{related work that does inter-loop scheduling, data transformations, and sparse format stuff}

\todo{Example of doing the three types of codes in RAJA or plain C++}

\section{Summary of Contributions}

\todo{Code examples using my approaches}

\todo{Enumerated problems that had to be solved to get there}

\todo{Contrubiton stuff that I have already}
